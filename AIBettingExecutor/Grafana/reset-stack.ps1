...
# ============================================
Write-Host "`n🗑️  STEP 2: Removing all AIBetting containers..." -ForegroundColor Yellow
Write-Host "----------------------------------------"
...
# ============================================
Write-Host "`n🌐 STEP 3: Cleaning networks..." -ForegroundColor Yellow
Write-Host "----------------------------------------"
...
# ============================================
if (-not $KeepData) {
    Write-Host "`n💾 STEP 4: Cleaning volumes..." -ForegroundColor Yellow
    Write-Host "----------------------------------------"
    ...
    if ($volumes) {
        ...
        Write-Host "ℹ️  No volumes to remove" -ForegroundColor Gray
    }
} else {
    Write-Host "`n💾 STEP 4: Keeping data volumes (--KeepData flag)" -ForegroundColor Cyan
}

# ============================================
# STEP 5: System Cleanup
# ============================================
Write-Host "`n🧹 STEP 5: System cleanup..." -ForegroundColor Yellow
Write-Host "----------------------------------------"
...
if ($remaining) {
    Write-Host "⚠️  WARNING: Some containers still exist:" -ForegroundColor Red
    ...
    Write-Host "✅ All containers successfully removed" -ForegroundColor Green
}

# ============================================
# STEP 7: Start Fresh Stack
# ============================================
Write-Host "`n🚀 STEP 7: Starting fresh monitoring stack..." -ForegroundColor Cyan
Write-Host "----------------------------------------"
...
# STEP 8: Status Check
# ============================================
Write-Host "`n📊 STEP 8: Container status..." -ForegroundColor Cyan
Write-Host "----------------------------------------"
...
Write-Host "`n✨ Monitoring stack is ready!`n" -ForegroundColor Green
